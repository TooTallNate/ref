...
/**
 * A Buffer that references the C NULL pointer. That is, it's memory address
 * points to 0. It's `length` is 0 because accessing any data from this buffer
 ...
 *
 * ```
 * console.log(new Buffer(1).address());
 * 4320233616
 *
 * console.log(ref.NULL.address());
 * 0
 * ```
 *
 ...
 *
 * ```
 * console.log(new Buffer(1).isNull());
 * false
 *
 ...
 * @param {Number} offset The offset to begin reading from.
 * @return {Object} The Buffer instance that was read from _buffer_.
 * @name readPointer
 * @type method
 */
 ...
 * @param {Buffer} buffer The buffer to read a Buffer from.
 * @param {Number} offset The offset to begin reading from.
 * @return {Object} The String that was read from _buffer_.
 * @name readCString
 * @type method
 */
