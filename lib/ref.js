 ...
 * The possible values are either `"LE"` and `"BE"`.
 *
 * ```
...
/**
 * `ref` overwrites the default `Buffer#inspect()` function to include the memory
 * address of the Buffer instance when invoked. This is simply a nice-to-have.
 *
 * **Before**:
 *
 * ``` js
